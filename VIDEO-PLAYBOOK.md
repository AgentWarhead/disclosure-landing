# Disclosure Video Content Playbook
**Locked in: Feb 27, 2026**
...
- TikTok (@getdisclosure)
- Instagram Reels (@disclosure_app)
- YouTube Shorts (@getdisclosure)

Cross-post every video to all three simultaneously.

## Hashtag Strategy

**Primary:** `#disclosure #alien #ufo #uap #aliensarereal #firstcontact #classified`
**Crossover reach:** `#creepytok #conspiracy #megalophobia #viral #fyp #ai #cinematic`
**Brand:** `#disclosureapp #getdisclosure #archetypequiz #stonecolddrills`
...
- Each should make the viewer FEEL something specific — awe, tenderness, fear, curiosity.
- No dialogue. Sound design carries the emotion (ambient, music, alien sounds).
- These build the emotional core of the brand. Quality over quantity.
...
- Green scanlines
- Timestamp (real date)
- "CLASSIFIED" or "INTERCEPTED" watermark
- DISCLOSURE logo bottom-right
- Species/signal designation text
...
```
Video (TikTok/IG/YT)
  → Link in bio: getdisclosure.app
  → Archetype quiz
  → First Contact Card (Apple/Google Wallet)
  → User shares card on their social
  → Their followers see it → take quiz
  → Loop repeats
```
...
*Every video is a window into the Disclosure universe. Every video stops the scroll. No exceptions.*
