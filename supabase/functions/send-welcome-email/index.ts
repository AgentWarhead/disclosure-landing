  ...
  <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation" style="max-width:470px;border:1px solid ${a.color};border-radius:26px;background:#061006;background-image:radial-gradient(circle at 50% 0,${a.glow},transparent 36%),linear-gradient(145deg,rgba(8,22,9,0.98),rgba(0,0,0,0.82));box-shadow:0 0 0 1px rgba(255,255,255,0.05),0 30px 90px rgba(0,0,0,0.66),0 0 70px ${a.glow};overflow:hidden;">
    <tr><td style="padding:24px 24px 0;">
      <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation"><tr>
        <td style="font-family:'Courier New',Courier,monospace;font-size:8px;letter-spacing:3px;color:rgba(255,255,255,0.58);">${esc(a.code)}</td>
...
<tr><td align="center" style="padding:0 0 36px;">
  <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation"><tr><td align="center" style="padding:0 0 12px;"><a href="${briefingUrl}" style="display:inline-block;background:#4AF626;color:#020302;font-family:'Courier New',Courier,monospace;font-size:11px;letter-spacing:3px;padding:17px 30px;text-decoration:none;font-weight:900;border-radius:999px;box-shadow:0 0 34px rgba(74,246,38,0.34);">ACCESS YOUR BRIEFING</a></td></tr><tr><td align="center"><a href="${dossierUrl}" style="font-family:'Courier New',Courier,monospace;font-size:10px;letter-spacing:2px;color:#DFFF8C;text-decoration:none;">OPEN ARCHETYPE DOSSIER</a><span style="color:rgba(255,255,255,0.22);padding:0 10px;">/</span><a href="${shareUrl}" style="font-family:'Courier New',Courier,monospace;font-size:10px;letter-spacing:2px;color:#FFD66B;text-decoration:none;">FORWARD THE SIGNAL</a></td></tr></table>
</td></tr>

<tr><td style="padding:22px 0 0;text-align:center;border-top:1px solid rgba(255,255,255,0.08);">
  <p style="margin:0 0 8px;font-family:'Courier New',Courier,monospace;font-size:8px;letter-spacing:3px;color:rgba(255,255,255,0.44);">BLACK CHANNEL FIELD PACKET // DO NOT IGNORE SKYBORNE ANOMALIES</p>
  <p style="margin:0;font-family:'Courier New',Courier,monospace;font-size:8px;letter-spacing:2px;color:rgba(255,255,255,0.26);">getdisclosure.app</p>
</td></tr>
</table>
</td></tr></table>
</body></html>`;
