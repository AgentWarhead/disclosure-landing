...
const ARCHETYPES: Record<string, ArchetypeEmail> = {
  ...
  "first-contact": {
    ...
    subject: "Black Channel file opened",
  ...
  <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation" style="max-width:470px;border:1px solid ${a.color};border-radius:26px;background:#061006;background-image:radial-gradient(circle at 50% 0,${a.glow},transparent 36%),linear-gradient(145deg,rgba(8,22,9,0.98),rgba(0,0,0,0.82));box-shadow:0 0 0 1px rgba(255,255,255,0.05),0 30px 90px rgba(0,0,0,0.66),0 0 70px ${a.glow};overflow:hidden;">
    <tr><td style="padding:24px 24px 0;">
      <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation"><tr>
        <td style="font-family:'Courier New',Courier,monospace;font-size:8px;letter-spacing:3px;color:rgba(255,255,255,0.84);">${esc(a.code)}</td>
        <td align="right" style="font-family:'Courier New',Courier,monospace;font-size:8px;letter-spacing:2px;color:#ffffff;">${serialSafe}</td>
      </tr></table>
    </td></tr>
    <tr><td align="center" style="padding:22px 24px 20px;">
      <div style="font-size:54px;line-height:1;margin-bottom:12px;">${a.icon}</div>
      <div style="font-family:'Courier New',Courier,monospace;font-size:24px;font-weight:900;letter-spacing:7px;color:${a.color};text-shadow:0 0 22px ${a.glow};">${esc(a.name)}</div>
      <div style="margin-top:8px;font-family:'Courier New',Courier,monospace;font-size:9px;letter-spacing:3px;color:#ffffff;">${esc(a.role)}</div>
      <p style="margin:18px auto 0;max-width:350px;font-size:15px;line-height:1.55;color:#ffffff;font-weight:700;">${esc(a.tagline)}</p>
    </td></tr>
    <tr><td style="padding:0 24px 22px;">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation" style="margin:16px 0 14px;"><tr><td style="padding-bottom:7px;"><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="font-family:'Courier New',Courier,monospace;font-size:8px;letter-spacing:2px;color:#ffffff;">${esc(a.bar_lbl)}</td><td align="right" style="font-family:'Courier New',Courier,monospace;font-size:8px;letter-spacing:2px;color:${a.color};font-weight:900;">${a.bar_pct}</td></tr></table></td></tr><tr><td style="background:rgba(255,255,255,0.11);height:9px;border-radius:999px;overflow:hidden;"><table width="${a.bar_w}" cellpadding="0" cellspacing="0" border="0"><tr><td style="background:linear-gradient(90deg,${a.color},#FFD700);height:9px;box-shadow:0 0 20px ${a.glow};">&nbsp;</td></tr></table></td></tr></table>
...
<tr><td style="padding:2px 0 24px;">
  <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation" style="border:1px solid rgba(216,255,155,0.20);border-radius:24px;background:rgba(0,0,0,0.52);box-shadow:inset 0 0 45px rgba(74,246,38,0.045);">
    <tr><td style="padding:24px;">
      <p style="margin:0 0 8px;font-family:'Courier New',Courier,monospace;font-size:10px;letter-spacing:4px;color:${a.color};font-weight:900;">FIELD DIRECTIVE</p>
      <p style="margin:0;font-size:18px;line-height:1.55;color:#ffffff;font-weight:800;">${esc(a.directive)}</p>
      <p style="margin:16px 0 0;font-size:15px;line-height:1.7;color:#ffffff;font-weight:600;">${esc(a.protocol)}</p>
    </td></tr>
  </table>
</td></tr>
...
<tr><td style="padding:0 0 28px;">
  <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation" style="border:1px solid rgba(255,255,255,0.12);border-radius:24px;background:linear-gradient(135deg,rgba(7,18,9,0.95),rgba(0,0,0,0.72));">
    <tr><td style="padding:22px 24px 8px;"><p style="margin:0;font-family:'Courier New',Courier,monospace;font-size:10px;letter-spacing:4px;color:#DFFF8C;font-weight:900;">LIVE MODULE STACK</p></td></tr>
    ${moduleRows}
  </table>
</td></tr>
...
<tr><td style="padding:22px 0 0;text-align:center;border-top:1px solid rgba(255,255,255,0.08);">
  <p style="margin:0 0 8px;font-family:'Courier New',Courier,monospace;font-size:8px;letter-spacing:3px;color:rgba(255,255,255,0.74);">BLACK CHANNEL FIELD PACKET // DO NOT IGNORE SKYBORNE ANOMALIES</p>
  <p style="margin:0;font-family:'Courier New',Courier,monospace;font-size:8px;letter-spacing:2px;color:rgba(255,255,255,0.82);">getdisclosure.app</p>
</td></tr>
</table>
</td></tr></table>
</body></html>`;
