  ...
  const moduleRows = a.modules.map((m, i) => `
    <tr><td style="padding:10px 0;border-bottom:1px solid rgba(255,255,255,0.07);">
      <table width="100%" cellpadding="0" cellspacing="0" border="0"><tr>
        <td style="width:42px;font-family:'Courier New',Courier,monospace;font-size:11px;letter-spacing:2px;color:${a.color};">0${i + 1}</td>
        <td style="font-family:Arial,Helvetica,sans-serif;font-size:14px;line-height:1.35;color:#ffffff;font-weight:700;">${esc(m)}</td>
        <td align="right" style="font-family:'Courier New',Courier,monospace;font-size:8px;letter-spacing:2px;color:rgba(255,255,255,0.78);">QUEUED</td>
      </tr></table>
    </td></tr>`).join("");
...
<tr><td style="padding:16px 0 24px;text-align:center;border-bottom:1px solid rgba(74,246,38,0.22);">
  <div style="display:inline-block;padding:9px 14px;border:1px solid rgba(216,255,155,0.24);border-radius:999px;background:rgba(0,0,0,0.5);box-shadow:0 0 30px ${a.glow};font-family:'Courier New',Courier,monospace;font-size:22px;font-weight:900;letter-spacing:3px;color:#4AF626;line-height:1;">DISCLOSURE <span style="font-size:9px;letter-spacing:2px;color:#ffffff;vertical-align:middle;">LIVE</span></div>
  <p style="margin:12px 0 0;font-family:'Courier New',Courier,monospace;font-size:9px;letter-spacing:4px;color:rgba(255,255,255,0.88);">FIRST CONTACT READINESS PROGRAM</p>
</td></tr>
<tr><td style="padding:34px 0 24px;text-align:center;">
  <p style="margin:0 0 10px;font-family:'Courier New',Courier,monospace;font-size:10px;letter-spacing:5px;color:${a.color};font-weight:700;">CLASSIFICATION ISSUED</p>
  <h1 style="margin:0;font-size:42px;line-height:0.92;letter-spacing:-1.6px;color:#ffffff;font-weight:900;text-transform:uppercase;">Your ${esc(a.name)} file<br/>is active.</h1>
  <p style="margin:18px auto 0;max-width:500px;font-size:16px;line-height:1.65;color:#ffffff;font-weight:700;">${esc(a.reveal)}</p>
</td></tr>
<tr><td align="center" style="padding:8px 0 30px;">
  <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation" style="max-width:470px;border:1px solid ${a.color};border-radius:26px;background:#061006;background-image:radial-gradient(circle at 50% 0,${a.glow},transparent 36%),linear-gradient(145deg,rgba(8,22,9,0.98),rgba(0,0,0,0.82));box-shadow:0 0 0 1px rgba(255,255,255,0.05),0 30px 90px rgba(0,0,0,0.66),0 0 70px ${a.glow};overflow:hidden;">
    <tr><td style="padding:24px 24px 0;"><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="font-family:'Courier New',Courier,monospace;font-size:8px;letter-spacing:3px;color:rgba(255,255,255,0.84);">${esc(a.code)}</td><td align="right" style="font-family:'Courier New',Courier,monospace;font-size:8px;letter-spacing:2px;color:#ffffff;">${serialSafe}</td></tr></table></td></tr>
    <tr><td align="center" style="padding:22px 24px 20px;"><div style="font-size:54px;line-height:1;margin-bottom:12px;">${a.icon}</div><div style="font-family:'Courier New',Courier,monospace;font-size:24px;font-weight:900;letter-spacing:7px;color:${a.color};text-shadow:0 0 22px ${a.glow};">${esc(a.name)}</div><div style="margin-top:8px;font-family:'Courier New',Courier,monospace;font-size:9px;letter-spacing:3px;color:#ffffff;">${esc(a.role)}</div><p style="margin:18px auto 0;max-width:350px;font-size:15px;line-height:1.55;color:#ffffff;font-weight:700;">${esc(a.tagline)}</p></td></tr>
    <tr><td style="padding:0 24px 22px;">
      <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-top:1px solid rgba(255,255,255,0.08);">
        <tr><td style="padding:10px 0;border-bottom:1px solid rgba(255,255,255,0.08);"><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="font-family:'Courier New',Courier,monospace;font-size:9px;letter-spacing:2px;color:rgba(255,255,255,0.92);">${esc(a.stat1[0])}</td><td align="right" style="font-family:'Courier New',Courier,monospace;font-size:9px;letter-spacing:2px;color:${a.color};font-weight:900;">${esc(a.stat1[1])}</td></tr></table></td></tr>
        <tr><td style="padding:10px 0;border-bottom:1px solid rgba(255,255,255,0.08);"><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="font-family:'Courier New',Courier,monospace;font-size:9px;letter-spacing:2px;color:rgba(255,255,255,0.92);">${esc(a.stat2[0])}</td><td align="right" style="font-family:'Courier New',Courier,monospace;font-size:9px;letter-spacing:2px;color:#ffffff;font-weight:900;">${esc(a.stat2[1])}</td></tr></table></td></tr>
        <tr><td style="padding:10px 0;border-bottom:1px solid rgba(255,255,255,0.08);"><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="font-family:'Courier New',Courier,monospace;font-size:9px;letter-spacing:2px;color:rgba(255,255,255,0.92);">${esc(a.stat3[0])}</td><td align="right" style="font-family:'Courier New',Courier,monospace;font-size:9px;letter-spacing:2px;color:#FFD66B;font-weight:900;">${esc(a.stat3[1])}</td></tr></table></td></tr>
        <tr><td style="padding:10px 0;"><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="font-family:'Courier New',Courier,monospace;font-size:9px;letter-spacing:2px;color:rgba(255,255,255,0.92);">ISSUED</td><td align="right" style="font-family:'Courier New',Courier,monospace;font-size:9px;letter-spacing:2px;color:#ffffff;">${issued}</td></tr></table></td></tr>
      </table>
      <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:16px 0 14px;"><tr><td style="padding-bottom:7px;"><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="font-family:'Courier New',Courier,monospace;font-size:8px;letter-spacing:2px;color:#ffffff;">${esc(a.bar_lbl)}</td><td align="right" style="font-family:'Courier New',Courier,monospace;font-size:8px;letter-spacing:2px;color:${a.color};font-weight:900;">${a.bar_pct}</td></tr></table></td></tr><tr><td style="background:rgba(255,255,255,0.11);height:9px;border-radius:999px;overflow:hidden;"><table width="${a.bar_w}" cellpadding="0" cellspacing="0" border="0"><tr><td style="background:linear-gradient(90deg,${a.color},#FFD700);height:9px;box-shadow:0 0 20px ${a.glow};">&nbsp;</td></tr></table></td></tr></table>
      <div style="border:1px solid rgba(216,255,155,0.28);border-radius:16px;padding:12px;text-align:center;font-family:'Courier New',Courier,monospace;font-size:9px;letter-spacing:3px;color:${a.color};font-weight:900;background:rgba(74,246,38,0.06);">${esc(a.status)}</div>
    </td></tr>
  </table>
  <p style="margin:12px 0 0;font-family:'Courier New',Courier,monospace;font-size:8px;letter-spacing:2px;color:rgba(255,255,255,0.82);text-align:center;">${serialSafe} // EARLY ENROLLMENT PRIORITY</p>
</td></tr>
<tr><td style="padding:2px 0 24px;"><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border:1px solid rgba(216,255,155,0.20);border-radius:24px;background:rgba(0,0,0,0.52);box-shadow:inset 0 0 45px rgba(74,246,38,0.045);"><tr><td style="padding:24px;"><p style="margin:0 0 8px;font-family:'Courier New',Courier,monospace;font-size:10px;letter-spacing:4px;color:${a.color};font-weight:900;">FIELD DIRECTIVE</p><p style="margin:0;font-size:18px;line-height:1.55;color:#ffffff;font-weight:800;">${esc(a.directive)}</p><p style="margin:16px 0 0;font-size:15px;line-height:1.7;color:#ffffff;font-weight:600;">${esc(a.protocol)}</p></td></tr></table></td></tr>
<tr><td style="padding:0 0 28px;"><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border:1px solid rgba(255,255,255,0.12);border-radius:24px;background:linear-gradient(135deg,rgba(7,18,9,0.95),rgba(0,0,0,0.72));"><tr><td style="padding:22px 24px 8px;"><p style="margin:0;font-family:'Courier New',Courier,monospace;font-size:10px;letter-spacing:4px;color:#DFFF8C;font-weight:900;">LIVE MODULE STACK</p></td></tr>${moduleRows}</table></td></tr>
<tr><td style="padding:0 0 28px;">
  <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border:1px solid rgba(74,246,38,0.34);border-radius:28px;background:#051006;background-image:radial-gradient(circle at 50% 0,rgba(74,246,38,0.22),transparent 42%),linear-gradient(135deg,rgba(7,24,10,0.98),rgba(0,0,0,0.78));box-shadow:0 0 60px rgba(74,246,38,0.14);">
    <tr><td style="padding:28px 24px;text-align:center;">
      <p style="margin:0 0 10px;font-family:'Courier New',Courier,monospace;font-size:10px;letter-spacing:4px;color:#4AF626;font-weight:900;">MOBILE APP INCOMING</p>
      <h2 style="margin:0 0 14px;font-size:30px;line-height:1.02;letter-spacing:-1px;color:#ffffff;font-weight:900;text-transform:uppercase;">Your card is step one.<br/>The app is the real training.</h2>
      <p style="margin:0 auto 18px;max-width:520px;font-size:16px;line-height:1.68;color:#ffffff;font-weight:800;">Disclosure is actively being built now and launching soon. The mobile app turns your archetype into drills, protocols, signal tools, species briefings, and a First Contact Card you can carry when the room goes quiet.</p>
      <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:18px 0 0;">
        <tr>
          <td style="padding:10px;border:1px solid rgba(216,255,155,0.26);border-radius:16px;background:rgba(74,246,38,0.08);"><p style="margin:0;font-family:'Courier New',Courier,monospace;font-size:9px;letter-spacing:2px;color:#DFFF8C;font-weight:900;">ANDROID TEST ACCESS</p><p style="margin:7px 0 0;font-size:13px;line-height:1.45;color:#ffffff;font-weight:700;">Early testing opportunities will open before public launch.</p></td>
        </tr>
        <tr><td style="height:10px;font-size:0;line-height:0;">&nbsp;</td></tr>
        <tr>
          <td style="padding:10px;border:1px solid rgba(255,215,0,0.28);border-radius:16px;background:rgba(255,215,0,0.08);"><p style="margin:0;font-family:'Courier New',Courier,monospace;font-size:9px;letter-spacing:2px;color:#FFD66B;font-weight:900;">LOW SERIALS BOARD FIRST</p><p style="margin:7px 0 0;font-size:13px;line-height:1.45;color:#ffffff;font-weight:700;">You are already in the queue. Friends who classify now enter before the signal gets loud.</p></td>
        </tr>
      </table>
    </td></tr>
  </table>
...
<tr><td align="center" style="padding:0 0 36px;">
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr><td align="center" style="padding:0 0 14px;"><a href="${briefingUrl}" style="display:inline-block;background:#4AF626;color:#020302;font-family:'Courier New',Courier,monospace;font-size:12px;letter-spacing:3px;padding:18px 34px;text-decoration:none;font-weight:900;border-radius:999px;box-shadow:0 0 38px rgba(74,246,38,0.42);">ACCESS YOUR BRIEFING</a></td></tr>
    <tr><td align="center" style="padding:0 0 20px;"><a href="${dossierUrl}" style="font-family:'Courier New',Courier,monospace;font-size:10px;letter-spacing:2px;color:#DFFF8C;text-decoration:none;font-weight:900;">OPEN ARCHETYPE DOSSIER</a></td></tr>
    <tr><td style="padding:20px;border:1px solid rgba(255,255,255,0.16);border-radius:22px;background:rgba(255,255,255,0.045);text-align:center;">
      <p style="margin:0 0 8px;font-family:'Courier New',Courier,monospace;font-size:10px;letter-spacing:4px;color:#FFD66B;font-weight:900;">SPREAD THE SIGNAL</p>
      <p style="margin:0 0 16px;font-size:15px;line-height:1.55;color:#ffffff;font-weight:800;">Post your classification. Challenge your group chat. Make them find out who they become when the sky stops pretending.</p>
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr><td style="padding:5px;"><a href="${shareUrl}" style="display:block;border:1px solid rgba(216,255,155,0.35);border-radius:999px;padding:13px 12px;color:#DFFF8C;text-decoration:none;font-family:'Courier New',Courier,monospace;font-size:10px;letter-spacing:2px;font-weight:900;background:rgba(74,246,38,0.08);">POST ON X</a></td></tr>
        <tr><td style="padding:5px;"><a href="${whatsappUrl}" style="display:block;border:1px solid rgba(34,197,94,0.35);border-radius:999px;padding:13px 12px;color:#ffffff;text-decoration:none;font-family:'Courier New',Courier,monospace;font-size:10px;letter-spacing:2px;font-weight:900;background:rgba(34,197,94,0.08);">SEND TO GROUP CHAT</a></td></tr>
        <tr><td style="padding:5px;"><a href="${facebookUrl}" style="display:block;border:1px solid rgba(96,165,250,0.35);border-radius:999px;padding:13px 12px;color:#ffffff;text-decoration:none;font-family:'Courier New',Courier,monospace;font-size:10px;letter-spacing:2px;font-weight:900;background:rgba(96,165,250,0.08);">SHARE ON FACEBOOK</a></td></tr>
        <tr><td style="padding:5px;"><a href="${mailFriendUrl}" style="display:block;border:1px solid rgba(255,215,0,0.35);border-radius:999px;padding:13px 12px;color:#FFD66B;text-decoration:none;font-family:'Courier New',Courier,monospace;font-size:10px;letter-spacing:2px;font-weight:900;background:rgba(255,215,0,0.08);">TELL A FRIEND</a></td></tr>
      </table>
    </td></tr>
  </table>
</td></tr>
<tr><td style="padding:22px 0 0;text-align:center;border-top:1px solid rgba(255,255,255,0.08);"><p style="margin:0 0 8px;font-family:'Courier New',Courier,monospace;font-size:8px;letter-spacing:3px;color:rgba(255,255,255,0.74);">BLACK CHANNEL FIELD PACKET // DO NOT IGNORE SKYBORNE ANOMALIES</p><p style="margin:0 0 10px;font-family:Arial,Helvetica,sans-serif;font-size:12px;line-height:1.6;color:rgba(255,255,255,0.82);">Only ${esc(a.pct)} of civilians share this designation. Most will not know their role until the signal is already overhead.</p><p style="margin:0;font-family:Arial,Helvetica,sans-serif;font-size:10px;color:rgba(255,255,255,0.88);"><a href="https://getdisclosure.app" style="color:rgba(255,255,255,0.84);text-decoration:none;">getdisclosure.app</a> &nbsp;•&nbsp; <a href="https://getdisclosure.app?unsub=1" style="color:rgba(255,255,255,0.78);text-decoration:none;">unsubscribe</a></p></td></tr>
</table></td></tr></table>
</body></html>`;
}
